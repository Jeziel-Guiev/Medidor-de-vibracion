...
var client= mqtt.connect('mqtt://128.199.14.19');//,{username:'josue', password:'password1234'});
var clientX=mqtt.connect('mqtt://128.199.14.19');
var clientY=mqtt.connect('mqtt://128.199.14.19');
var clientZ=mqtt.connect('mqtt://128.199.14.19');
var clientT=mqtt.connect('mqtt://128.199.14.19');
